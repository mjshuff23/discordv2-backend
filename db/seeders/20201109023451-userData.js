...
module.exports = {
  up: async (queryInterface, Sequelize) => {
      ...
      await queryInterface.bulkInsert('Users', [
        ...
        { username: 'RyanB', email: 'ryan@black.com', hashedPassword: hashedPassword, createdAt: new Date(), updatedAt: new Date() },

        { username: 'RyanY', email: 'ryan@young.com', hashedPassword: hashedPassword, createdAt: new Date(), updatedAt: new Date() },
